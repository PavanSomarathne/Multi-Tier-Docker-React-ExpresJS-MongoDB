...
class Add extends Component {
  ...
  async handleSubmit(event) {
    ...
    if (this.state.name.trim() != "" && this.state.description.trim() != ""&& this.state.COVID_status.trim() != ""&& this.state.image.trim() != "") {
      try {
  ...
  render() {
    ...
    return (
      <div className="container">
        <h4 className="mt-5 text-center">Add a Tourist attraction</h4>
        <div className="row">
        ...
        <div className="">
        <h4 className="mt-5 text-center">List of Tourist Attractions</h4>
